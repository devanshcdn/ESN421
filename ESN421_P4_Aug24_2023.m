...
if iex == 5
    ...
    for ii=1:length(xvec)
        ...
        yvec(ii+1) = yvec(ii) + dydx(x0 + (ii-1)*deltax, yvec(ii))*deltax;
%         XXX
...
%     k4 = XXX;
    ...
    for ii=1:length(xvec)
        ...
        yvec(ii+1) = yvec(ii) + (1/6) * (k1(xvec(ii), yvec(ii)) + (2 * k2(xvec(ii), yvec(ii))) + (2 * k3(xvec(ii), yvec(ii))) + (k4(xvec(ii), yvec(ii))))
%         XXX
